...
module.exports = function() {
  ...
  this.generateJavaScript = function(rules, udts, fileName) {
    ...
    try {
      ...
      // Display the grammar that produced these opcodes as comments at the end
      // of the file. This is handy when only the grammar object is available
      // and you need to know what SABNF grammar generated it.
      var str;
      fs.writeSync(fd, "\n");
      fs.writeSync(fd, "//```\n");
